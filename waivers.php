...
<html class="no-js" lang="en" dir="ltr">
  <head>
	...
	<link rel="stylesheet" href="css/waivers.css">
  ...
  <body>
	...
	<div class="grid-container full"> 
		<div class="grid-x eventnav">
			<div class="cell small-12 selected-event"><h4></h4></div>
		</div>
	</div>
	 
	<div class="grid-container full"> 
	 	<div class="grid-x eventnav-expanded">
	 		<div class="cell small-12 eventselect" id="eid1"><h4>Quiksilver Pro Gold Coast</h4></div>
	...
	<script src="js/custom/waivers.js"></script>
